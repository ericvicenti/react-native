    ...
    if (0 === (workInProgress.effectTag & 1024)) {
      ...
      switch (current$$1.tag) {
        ...
        case 13:
          ...
          (null !== instance && instance.didTimeout) !==
      ...
      if (
        ...
        for (
          ...
          (current = rootContainerInstance.expirationTime),
            ...
            current > instance && (instance = current),
        ...
        if (effectTag$jscomp$0 & 36) {
          ...
          switch (lastEffect.tag) {
            ...
            case 1:
              ...
              if (lastEffect.effectTag & 4)
                if (null === current$$1$jscomp$1)
                  (instance$jscomp$1.props = lastEffect.memoizedProps),
                    (instance$jscomp$1.state = lastEffect.memoizedState),
            ...
            case 12:
              break;
            case 13:
              if (lastEffect.effectTag & 32) {
                lastEffect.memoizedState = {
                  alreadyCaptured: !0,
                  didTimeout: !1,
                  timedOutAt: 0
                };
                flushPassiveEffects();
                scheduleWork(lastEffect, 1073741823);
                break;
              }
              var newState = lastEffect.memoizedState;
              null !== newState &&
                (destroy = newState.didTimeout) &&
                ((newState.alreadyCaptured = !1),
